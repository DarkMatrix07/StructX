...
import { closeAllDbs } from './db-pool';
...
export async function runMcpServer(defaultRepo: string): Promise<void> {
  ...
  logger.info(`StructX MCP server ready (default repo: ${defaultRepo})`);
